...
import com.ayaavdews.appsistatib.RecyclerView.RecyclerViewSiswaGuruAdapter;
...
public class FragmentTatib extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_tatib, container, false);
        ...
        RecyclerViewSiswaGuruAdapter myAdapter = new RecyclerViewSiswaGuruAdapter(getActivity(), kelas);
